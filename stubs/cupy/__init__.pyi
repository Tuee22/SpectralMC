...
class ndarray:
    ...
    def all(self, axis: int | Tuple[int, ...] | None = ..., keepdims: bool = ...) -> bool: ...
...
def isfinite(x: _ArrayLike) -> ndarray: ...

# FFT submodule (minimal)
class _FFTModule(Protocol):
    def fft(self, a: ndarray, axis: int = ...) -> ndarray: ...
...
class _RandomNS:
    ...
    def randn(self, *size: int) -> ndarray: ...
