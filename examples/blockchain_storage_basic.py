...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("\nBlockchainModelStore initialized")

        # Create genesis commit
        print("\n=== Genesis Commit ===")
        checkpoint1 = b"Model weights at epoch 0"
        content_hash1 = "abc123def456"
        version1 = store.commit(checkpoint1, content_hash1, "Initial model")
        ...
        version2 = store.commit(checkpoint2, content_hash2, "After 100 epochs")
        ...
        version3 = store.commit(checkpoint3, content_hash3, "After 200 epochs")
